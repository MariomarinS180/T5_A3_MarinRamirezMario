    ...
    public void agregarAlumno(View v){
        ...
        if(network != null && cm.getNetworkCapabilities(cm.getActiveNetwork()) != null ){
            ...
            new Thread(new Runnable() {
                @Override
                public void run() {
                    String url = "http://localhost/sistema_abcc/API_REST_MYSQL/api_altas.php";
                    String metodo = "POST";
                    Map<String, String> mapaDatos  =new HashMap<>();
                    mapaDatos.put("num_control", "180");
                    mapaDatos.put("nombre", "Mario");
                    mapaDatos.put("primer_ap", "Marin");
                    mapaDatos.put("segundo_ap", "Ramirez");
                    mapaDatos.put("edad", "21");
                    mapaDatos.put("semestre", "7");
                    mapaDatos.put("carrera", "ISC");
